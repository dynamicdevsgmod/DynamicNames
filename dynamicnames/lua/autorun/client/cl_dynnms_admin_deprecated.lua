...
function DynamicNames.OpenDeprecatedAdminMenu()
    if !DynamicNames.AdminGroups[LocalPlayer():GetUserGroup()] then return end
        ...
        DynamicNames.AdminMenu:SetSize(scrw * .5, scrh * .6)
        ...
        adminHeader:SetTall( DynamicNames.AdminMenu:GetTall() * .1)
        ...
        adminTitle:SetPos(adminHeader:GetWide() * 5.5, adminHeader:GetTall() * .25)
        ...
        net.Receive("dynNms_tableToClient", function()
            ...
            local skipLblPnl = 1
            function tDynNms_GeneratePlyPanel()
